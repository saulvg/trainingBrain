...
const {newExercise, getExercises, addExerciseToWorkout, getExercisesToWorkout} = require('./controllers/train');
...
app.get('/users/profile/exercises/workout_day', isAuth, getExercisesToWorkout)
